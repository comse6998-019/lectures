...
\begin{figure}[htbp]
  \centering
  \begin{adjustbox}{width=\linewidth}\input{figures/seq-agentless.tikz}\end{adjustbox}
...
\begin{figure}[htbp]
  \centering
  \input{figures/search-replace-format.tex}
...
\citet{xia2025agentless}, \S1, \S\S3.1--3.2, and Figure~1. These notes also draw on

...
\begin{table}[htbp]
  ...
  \begin{adjustbox}{width=\linewidth}\begin{tabularx}{\linewidth}{XXX}
    \toprule
...
\begin{table*}[tbp]
  ...
  \begin{adjustbox}{width=\linewidth}\begin{tabularx}{\linewidth}{XXXr}
    \toprule
...
\begin{figure}[htbp]
  \centering
  \begin{adjustbox}{width=\linewidth}\input{figures/reactive-loop.tikz}\end{adjustbox}
...
\begin{figure}[htbp]
  \centering
  \begin{adjustbox}{width=\linewidth}\input{figures/seq-loop-run.tikz}\end{adjustbox}

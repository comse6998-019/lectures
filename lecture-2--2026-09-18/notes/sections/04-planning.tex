...
\begin{figure}[htbp]
  \centering
  \begin{adjustbox}{width=\linewidth}\input{figures/graph-plan-validate.tikz}\end{adjustbox}
...
\citet{sun2023adaplanner}, \S2 for the open-loop and closed-loop distinction, \S\S3.1

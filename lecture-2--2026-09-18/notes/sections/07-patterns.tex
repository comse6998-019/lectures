...
\begin{table*}[tbp]
  ...
  \begin{adjustbox}{width=\linewidth}\begin{tabularx}{\linewidth}{L{0.17\linewidth}L{0.13\linewidth}XX}
    \toprule
...
\begin{table}[htbp]
  ...
  \begin{adjustbox}{width=\linewidth}\begin{tabularx}{\linewidth}{L{0.24\linewidth}L{0.29\linewidth}X}
    \toprule
...
\begin{table*}[tbp]
  ...
  \begin{adjustbox}{width=\linewidth}\begin{tabularx}{\linewidth}{L{0.14\linewidth}XXXX}
    \toprule
...
\begin{center}
\begin{adjustbox}{width=\linewidth}\begin{tabularx}{\linewidth}{@{}L{0.42\linewidth}X@{}}
  \toprule
